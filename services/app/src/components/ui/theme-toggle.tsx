...
export function ThemeToggle() {
  ...
  return (
    <div className="flex items-center gap-1">
      ...
      {/* Dojo Color Style Selector Menu */}
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-56 rounded-2xl border-zinc-200 dark:border-zinc-800 p-2">
          ...
          >
            ...
            {themeStyle === "professional" && <Check className="h-4 w-4 text-emerald-500" />}
          </DropdownMenuItem>
        </DropdownMenuContent>
      </DropdownMenu>
    </div>
